...
//
// The site's Tailwind `content` globs deliberately exclude stories (see
...
// and grids out of `className` altogether keeps that boundary from turning into
// a judgement call: only design-token classes the site itself uses belong in a
// story's `className`.
